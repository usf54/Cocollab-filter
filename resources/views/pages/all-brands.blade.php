                                    ...
                                    <div class="rts__author__card style__default d-flex flex-column gap-3">
                                        ...
                                        <div class="job__meta w-100 d-flex flex-column gap-3">
                                            <div class="d-flex flex-column align-items-center gap-1">
                                                ...
                                                <a href="{{ route('brandprofile', ['id' => $brand->id]) }}" class="job__title h6 mb-0">{{ $brand->brandName }}</a>
                                                <span class="author">{{ $brand->brandDescription }}</span>
                                            </div>
                                            ...
                                            <a href="{{ route('brandprofile', ['id' => $brand->id]) }}" class="apply__btn max-content">View Profile</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                                    ...
                                    <div class="col-12">
                                        <div class="rts__author__card__big style__gradient__two flex-wrap d-flex justify-content-between align-items-center gap-3">
                                            <div class="d-flex gap-3 gap-md-4 flex-column flex-md-row justify-content-start align-items-start align-items-md-center">
                                                ...
                                                <div class="job__meta">
                                                    <div class="d-flex align-items-start flex-column">
                                                        <!-- Display the brand name -->
                                                        <a href="{{ route('brandprofile', ['id' => $brand->id]) }}" class="job__title mb-0 h6 fw-semibold">{{ $brand->brandName }}</a>
                                                        <span class="d-block fw-medium">{{ $brand->brandDescription }}</span>
                                                    </div>
                                            ...
                                            <div class="d-flex gap-5 flex-wrap align-items-center">
                                                ...
                                                <!-- Link to the brand profile -->
                                                <a href="{{ route('brandprofile', ['id' => $brand->id]) }}" class="apply__btn" aria-label="View Profile">View Profile</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
