        ...
        <div class="row justify-content-center position-relative">
            <div class="col-xl-6 col-lg-10">
                <div class="rts__section__content text-center mb-60">
                    <h3 class="rts__section__title section__mb">Autres Influenceur</h3>
                </div>
            </div>
                    ...
                    <div class="rts__job__card style__five">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="featured__option">
                                <span><a style="color: black;" href="{{route('influencerprofile')}}">Voir Profil</a> </span>
                            </div>
                        </div>
                        ...
                        <div class="font-20 fw-medium job__title mt-3 mb-2">
                            <a href="{{route('influencerprofile')}}" aria-label="job" class="job__title">
